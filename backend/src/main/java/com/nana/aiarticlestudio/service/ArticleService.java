...
public interface ArticleService {
    ...
    ArticleVO getByTaskId(
            String taskId
    );

    PageResult<ArticleVO> listArticles(
            ArticleListRequest request
    );

    Boolean deleteByTaskId(
            String taskId
    );

    ArticleVO generateTitles(
            String taskId
    );

    ArticleVO confirmTitleAndGenerateOutline(
    ...
    ArticleVO saveOutline(
            SaveOutlineRequest request
    );

    ArticleVO generateContent(
            String taskId
    );

    ArticleVO saveContent(
            SaveContentRequest request
    );

    ArticleVO generateImagePrompts(
            String taskId
    );

    ArticleVO continueWorkflow(
            String taskId
    );
    ...
    ArticleVO composeArticle(
            String taskId
    );

    ArticleVO saveModelConfig(
            SaveModelConfigRequest request
    );

    SseEmitter streamGenerateContent(
            String taskId
    );

    SseEmitter realStreamGenerateContent(
            String taskId
    );
}